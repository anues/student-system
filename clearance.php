...
<head>
    <meta charset="UTF-8">
    <title>نموذج إخلاء طرف وسحب ملف - <?= htmlspecialchars($student['full_name']) ?></title>
    <style>
        @page {
            size: A4;
            margin: 10mm;
        ...
        .registrar-approval {
            text-align: center;
            margin-top: 35px; /* زيادة المسافة للأسفل لتبعد تماماً عن النقاط */
        }
...
<div class="paper">
    <div class="page-border">
        ...
        <div class="doc-title">نموذج إخلاء طرف وسحب ملف من الكلية</div>
        ...
        <div class="request-text">
            اتقدم اليكم بطلب إخلاء طرفي وسحب ملفي الشخصي من الكلية للأسباب التالية:
        </div>

        <!-- أسطر النقاط لأسباب السحب (سطران) -->
        <div class="dots-line"></div>
        <div class="dots-line"></div>

        <!-- قسم التوقيعات والاعتماد -->
        <div class="signatures-section">
            <!-- توقيع الطالب على اليمين -->
            <div class="student-sig-box">
                <div>توقيع الطالب:</div>
                <div class="student-dots"></div>
            </div>

            <!-- رأي مسجل الكلية في السطر الذي بعده -->
            <div class="registrar-opinion">رأي مسجل الكلية:</div>

            <!-- سطرين نقط ممتدة من اليمين لليسار -->
            <div class="full-dots"></div>
            <div class="full-dots"></div>

            <!-- اعتماد مسجل الكلية في المنتصف مع مسافة بعيدة وآمنة عن النقاط -->
            <div class="registrar-approval">اعتماد مسجل الكلية</div>
        </div>
