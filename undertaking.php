...
<head>
    <meta charset="UTF-8">
    <title>نموذج تعهد - <?= htmlspecialchars($student['full_name']) ?></title>
    <style>
        @page {
            size: A4;
            margin: 10mm;
...
<div class="no-print">
    <button onclick="window.print()" class="btn-print">طباعة التعهد</button>
...
<div class="paper">
    <div class="page-border">
        ...
        <div class="doc-title">نموذج تعهد طالب</div>

        <!-- جدول البيانات (الرقم الدراسي، الاسم، الفصل الدراسي، الجنسية) -->
        <table class="student-info-table">
            <tr>
                <td class="label-cell">الرقم الدراسي:</td>
                <td class="value-cell"><?= htmlspecialchars($student['academic_id']) ?></td>
                <td class="label-cell" style="padding-right: 30px;">الجنسية:</td>
            ...
            <tr>
                <td class="label-cell">الفصل الدراسي:</td>
                <td class="value-cell" colspan="3"><?= htmlspecialchars($student['academic_level']) ?></td>
            </tr>
        </table>

        <!-- الدباجة -->
        <div class="request-text">
            أنا الموقع أدناه أتقدم بطلب أتعهد فيه بالآتي:
        </div>

        <!-- أسطر النقاط (ثلاثة أسطر) -->
