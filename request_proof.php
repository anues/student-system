...
<head>
    <meta charset="UTF-8">
    <title>نموذج طلب الحصول على إثبات مستوى دراسي - <?= htmlspecialchars($student['full_name']) ?></title>
    <style>
        @page {
            size: A4;
            margin: 10mm;
...
/* ضبط محاذاة النص مع بداية النقاط في اليسار */
.sig-left { 
    text-align: left; 
    width: 50%; 
}
...
.sig-box-left {
    ...
    text-align: right; /* يبدأ النص والنقاط من نفس المحاذاة */
}
...
<div class="paper">
    <div class="page-border">
        ...
        <!-- الترويسة متضمنة الشعار في المنتصف -->
            ...
            <tr>
                ...
                <td class="header-left">
                    <div class="meta-container">
                        <div class="code-box">ج.م.س / 04 / 005</div>
        ...
        <div class="doc-title">نموذج طلب الحصول على إثبات مستوى دراسي</div>

        <div style="font-size: 19px; line-height: 2;">أتقدم إليكم أنا الطالب/ة الموضحة بياناتي أدناه بطلبي هذا للحصول على إثبات مستوى دراسي:</div>
